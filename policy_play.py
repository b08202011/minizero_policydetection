...
class PolicyPlay():
    def __init__(self, game_type, conf_file,test_file):
        ...
        self.env = py.Env()
        self.model = Model()
        self.load_model('dan_training_new/model/weight_iter_400000.pkl')
        #self.load_model('dan_training_new/model/weight_iter_380000.pkl')
        #self.load_model('dan_training_newloss2/model/weight_iter_140000.pkl')ver3
    ...
    def generate_games(self):
        ...
        # apply softmax temperature & play
            ...
            with open('best1.csv','a') as f:
                answer_row = games_id[i+11340] + ',' + ','.join(prediction_chars[0]) + '\n'
